  ...
  <svg viewBox="0 0 100 100" className="service-svg-illustration" fill="none">
    <defs>
      <linearGradient id="pdGradBg" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#161307" />
        <stop offset="100%" stopColor="#0f0d05" />
      </linearGradient>
      <linearGradient id="pdGradGlass" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="rgba(181, 166, 66, 0.3)" />
        <stop offset="100%" stopColor="rgba(255, 255, 255, 0.05)" />
      </linearGradient>
      <linearGradient id="pdGradAccent" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#B5A642" />
        <stop offset="100%" stopColor="#D4C15A" />
      </linearGradient>
      <radialGradient id="pdGlow" cx="50%" cy="50%" r="50%">
        <stop offset="0%" stopColor="#B5A642" stopOpacity="0.45" />
        <stop offset="100%" stopColor="#B5A642" stopOpacity="0" />
      </radialGradient>
    </defs>
    ...
    <path d="M50 72 L88 53 L50 34 L12 53 Z" fill="url(#pdGradBg)" stroke="rgba(181, 166, 66, 0.25)" strokeWidth="1.2" />
  ...
  <svg viewBox="0 0 100 100" className="service-svg-illustration" fill="none">
    <defs>
      <linearGradient id="uxGradTarget" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#0f0d05" />
        <stop offset="100%" stopColor="#161307" />
      </linearGradient>
      <linearGradient id="uxGradGlass" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="rgba(181, 166, 66, 0.25)" />
        <stop offset="100%" stopColor="rgba(212, 193, 90, 0.08)" />
      </linearGradient>
      <linearGradient id="uxGradMetal" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#ffffff" stopOpacity="0.65" />
        <stop offset="50%" stopColor="#B5A642" stopOpacity="0.8" />
        <stop offset="100%" stopColor="#161307" stopOpacity="0.95" />
      </linearGradient>
      <radialGradient id="uxGlow" cx="50%" cy="50%" r="50%">
        <stop offset="0%" stopColor="#B5A642" stopOpacity="0.4" />
        <stop offset="100%" stopColor="#B5A642" stopOpacity="0" />
      </radialGradient>
    </defs>
    ...
    <path d="M50 76 L86 58 L50 40 L14 58 Z" fill="url(#uxGradTarget)" stroke="rgba(181, 166, 66, 0.3)" strokeWidth="1.5" />
    <ellipse cx="50" cy="58" rx="24" ry="12" stroke="rgba(181, 166, 66, 0.18)" strokeWidth="1.2" fill="none" />
    <ellipse cx="50" cy="58" rx="14" ry="7" stroke="rgba(212, 193, 90, 0.3)" strokeWidth="1.2" fill="none" />
    
    {/* Floating 3D Column 1 (Left-back, teal) */}
    <path d="M30 46 L36 43 L42 46 L36 49 Z" fill="#B5A642" />
    <path d="M30 46 L30 62 L36 65 L36 49 Z" fill="#625923" />
    <path d="M36 49 L36 65 L42 62 L42 46 Z" fill="#786d2b" />
    
    {/* Floating 3D Column 2 (Right-front, taller, neon green) */}
    <path d="M46 32 L52 29 L58 32 L52 35 Z" fill="#D4C15A" />
    <path d="M46 32 L46 54 L52 57 L52 35 Z" fill="#8c7d32" />
    <path d="M52 35 L52 57 L58 54 L58 32 Z" fill="#bfae49" />
    ...
    <circle cx="72.5" cy="64.5" r="2" fill="#B5A642" />
  </svg>
);
  ...
  <svg viewBox="0 0 100 100" className="service-svg-illustration" fill="none">
    <defs>
      <linearGradient id="stGradTop" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#D4C15A" />
        <stop offset="100%" stopColor="#B5A642" />
      </linearGradient>
      <linearGradient id="stGradLeft" x1="0%" y1="0%" x2="0%" y2="100%">
        <stop offset="0%" stopColor="#201c0a" />
        <stop offset="100%" stopColor="#0d0b04" />
      </linearGradient>
      <linearGradient id="stGradRight" x1="0%" y1="0%" x2="0%" y2="100%">
        <stop offset="0%" stopColor="#463f1a" />
        <stop offset="100%" stopColor="#1b180a" />
      </linearGradient>
    </defs>
    ...
    <line x1="52" y1="31" x2="64" y2="57" stroke="#D4C15A" strokeWidth="1.5" strokeDasharray="3 2" />
    <line x1="52" y1="31" x2="40" y2="49" stroke="#D4C15A" strokeWidth="1.5" strokeDasharray="3 2" />
    
    {/* Glowing Nodes */}
    <circle cx="52" cy="31" r="3.5" fill="#ffffff" filter="drop-shadow(0 0 3px #D4C15A)" />
    <circle cx="64" cy="57" r="3" fill="#B5A642" />
    <circle cx="40" cy="49" r="3" fill="#B5A642" />
  </svg>
);
  ...
  <svg viewBox="0 0 100 100" className="service-svg-illustration" fill="none">
    <defs>
      <linearGradient id="devGradBg" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#0a0903" />
        <stop offset="100%" stopColor="#181506" />
      </linearGradient>
    ...
    {/* Window front face */}
    <path d="M20 45 L59 23 L59 57 L20 79 Z" fill="url(#devGradBg)" stroke="rgba(181, 166, 66, 0.35)" strokeWidth="1.2" />
    ...
    <line x1="27" y1="56" x2="48" y2="44" stroke="#B5A642" strokeWidth="2" strokeLinecap="round" />
...
const ProjectsView = ({
  ...
  return (
    <div className="projects-page-view">
      <div className="saas-gradient-overlay" style={{ background: 'radial-gradient(circle at 50% 50%, rgba(181, 166, 66, 0.05) 0%, transparent 60%)' }} />
              ...
              <svg className="preloader-logo-svg" width="90" height="90" viewBox="0 0 75 75" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                  <radialGradient id="paint0_radial_preloader" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(37.5 37.5) rotate(90) scale(37.5)">
                    <stop stopColor="#B5A642"/>
                    <stop offset="1" stopColor="#D4C15A" stopOpacity="0.8"/>
                  </radialGradient>
                </defs>
              </svg>
            </div>
